...
public class SymmetryVerticalResult {
    ...
    public SymmetryVerticalResult(double percentage, int allVisitedPixels, int symmetricalPixels, int nonSymmetricalPixels) {
